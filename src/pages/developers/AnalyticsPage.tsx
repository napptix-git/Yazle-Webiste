  ...
  const analyticFeatures = [
    {
      ...
      description: "Monitor performance metrics in real-time with customizable dashboards.",
      icon: <BarChart className="h-8 w-8 text-[#29dd3b]" />
    },
    {
      title: "User Segmentation",
      description: "Analyze player behavior based on demographics and gameplay patterns.",
      icon: <Users className="h-8 w-8 text-[#29dd3b]" />
    },
    {
      title: "Revenue Attribution",
      description: "Track revenue sources across ad formats and placements for optimization.",
      icon: <PieChart className="h-8 w-8 text-[#29dd3b]" />
    },
    {
      title: "Trend Analysis",
      description: "Identify patterns and predict future performance with AI forecasting.",
      icon: <LineChart className="h-8 w-8 text-[#29dd3b]" />
    },
    {
      title: "Conversion Funnels",
      description: "Map the player journey from impression to conversion.",
    ...
    <div className="min-h-screen bg-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-napptix-light-grey font-roboto-mono text-xl mb-8">
                Turn data into insights to optimize your game.
              </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-napptix-light-grey font-roboto-mono text-center mb-16 max-w-2xl mx-auto">
            Preview our intuitive analytics interface
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-napptix-light-grey font-roboto-mono mb-8 max-w-xl mx-auto">
            Turn insights into action with Napptix
          </p>
